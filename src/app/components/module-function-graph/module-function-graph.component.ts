...
*/
  ...
  downloadSVG(): void {
    downloadSvg(this.container.nativeElement, 'module-function-graph.svg');
  }

  downloadPNG(): void {
    downloadPng(this.container.nativeElement, this.width, this.height, 'module-function-graph.png');
  }
}
